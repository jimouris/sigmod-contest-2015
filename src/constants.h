...
#define TID_GLOBAL_DEPTH_INIT 10		/* tidHash init depth */
#define PREDICATE_GLOBAL_DEPTH_INIT 15	/* predicateHash init depth */
#define B 10								/* Number of keys for each PKBucket */
#define TID_B 10							/* Number of keys for each tidBucket */
#define PREDICATE_B 10					/* Number of keys for each predicateBucket*/
